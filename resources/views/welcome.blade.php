        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 white:bg-gray-900 sm:items-center sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/home') }}" class="text-center text-sm text-white-700 underline">Cadastro</a>
                    @else
                        <a href="{{ route('login') }}" class="text-sm text-white-700 underline">Login</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-sm text-white-700 underline">Registrar</a>
                        @endif
                    @endauth
                </div>
            @endif
